...
class TD3BaseAgent(ABC):
	...
	def load(self, load_path):
		...
		self.target_critic_net1.load_state_dict(checkpoint['critic1'])
		self.target_critic_net2.load_state_dict(checkpoint['critic2'])
